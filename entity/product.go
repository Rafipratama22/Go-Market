...
type Product struct {
	...
	BarcodeNumber       string    `json:"barcode_number" binding:"required" gorm:"type:varchar(100);unique;primary_key;"`
	...
	Hastag              string    `gorm:"type:text" json:"hastag"`
	...
	Image_1_Original    string    `gorm:"type:text" json:"image_1_original"`
	Image_1_Medium      string    `gorm:"type:text" json:"image_1_medium"`
	Image_1_Small       string    `gorm:"type:text" json:"image_1_small"`
	Image_1_Thumbnail   string    `gorm:"type:text" json:"image_1_thumbnail"`
	Image_2_Original    string    `gorm:"type:text" json:"image_2_original"`
	Image_2_Medium      string    `gorm:"type:text" json:"image_2_medium"`
	Image_2_Small       string    `gorm:"type:text" json:"image_2_small"`
	Image_2_Thumbnail   string    `gorm:"type:text" json:"image_2_thumbnail"`
	Image_3_Original    string    `gorm:"type:text" json:"image_3_original"`
	Image_3_Medium      string    `gorm:"type:text" json:"image_3_medium"`
	Image_3_Small       string    `gorm:"type:text" json:"image_3_small"`
	Image_3_Thumbnail   string    `gorm:"type:text" json:"image_3_thumbnail"`
	Image_4_Original    string    `gorm:"type:text" json:"image_4_original"`
	Image_4_Medium      string    `gorm:"type:text" json:"image_4_medium"`
	Image_4_Small       string    `gorm:"type:text" json:"image_4_small"`
	Image_4_Thumbnail   string    `gorm:"type:text" json:"image_4_thumbnail"`
	Smarthchoice        string    `gorm:"type:text" json:"smarthchoice"`
